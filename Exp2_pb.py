...
if __name__ == '__main__':
	...
	# 	get_ntp_time(servidor)
	# final = datetime.datetime.now()

	# print(f"\n\nTiempo de ejecucion sin threads: {final-inicio}")
    
    # Escriba aquí su código para la parte b (puede hacerlo en un archivo separado también, ambas opciones son válidas
	inicio = datetime.datetime.now()
	threads = []
	for servidor in servidores_ntp:
		t = threading.Thread(target=get_ntp_time, args=(servidor,))
		threads.append(t)
		t.start()
	...
	print(f"Tiempo de ejecucion con threads: {final-inicio}")